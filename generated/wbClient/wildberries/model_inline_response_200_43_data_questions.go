...
type InlineResponse20043DataQuestions struct {
	// id вопроса
	...
	Answer *InlineResponse20043DataAnswer `json:"answer,omitempty"`
	ProductDetails *InlineResponse20043DataProductDetails `json:"productDetails,omitempty"`
