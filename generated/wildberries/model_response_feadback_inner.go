...
type ResponseFeadbackInner struct {
	// Id отзыва
	...
	// Структура товара
	ProductDetails *interface{} `json:"productDetails,omitempty"`
	// Массив структур фотографий
	PhotoLinks []interface{} `json:"photoLinks,omitempty"`
	// Структура видео
	...
	IsCreationSupplierComplaint bool `json:"isCreationSupplierComplaint,omitempty"`
	// Жалоба на отзыв
	SupplierComplaint *interface{} `json:"supplierComplaint,omitempty"`
}
