...
type InlineResponse20034Params struct {
	...
	Intervals []InlineResponse20034Intervals `json:"intervals,omitempty"`
	// Текущая ставка
	...
	MenuName any `json:"menuName,omitempty"`
	// Массив номенклатур РК
	Nms []InlineResponse20034Nms `json:"nms,omitempty"`
}
